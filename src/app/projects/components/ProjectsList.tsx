    ...
    >
      ...
      <div className='flex flex-col justify-between items-start gap-2 md:gap-4 py-4 border border-input rounded-lg'>
        <div className='flex flex-col gap-4 w-full'>
          ...
          <p className='md:text-xl px-4'>Effortless to create your customize beautiful and small blur image placeholder.</p>
          <div className='flex gap-2 px-4 mb-4'>
            <StackIcon name="typescript" className='w-6 sm:w-8' />
            <StackIcon name="nextjs2" className='w-6 sm:w-8' />
            <StackIcon name="tailwindcss" className='w-6 sm:w-8' />
        ...
        <div className='flex justify-between w-full px-4'>
          <a href='https://thumbhash-generator.vercel.app/' target='_blank'>
            <Button className='md:text-lg'>
              Live
              <ExternalLink className='ml-2' />
            </Button>
          </a>
          <a href='https://github.com/hidayahapriliansyah/thumbhash-generator' target='_blank' className='flex justify-center items-center text-zinc-950 dark:text-white'>
            <Github className='ml-2' />
          </a>
        </div>
      </div>
